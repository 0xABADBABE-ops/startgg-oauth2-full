...
export default function HomePage() {
	...
	return (
		<main>
			...
			<p>
				This demo calls <code>buildAuthorizeUrl</code> on the server, stores the
				PKCE verifier in memory, and exchanges the authorization code in the
				callback API route. Update <code>.env.local</code> with your Start.gg
				client values before proceeding.
			</p>
			...
			<section>
				<h2>Authorize</h2>
				<p>
					Click the button to request a Start.gg authorize URL. The link appears
					below so you can inspect it before visiting. After finishing the
					Start.gg flow you&apos;ll be redirected back here and the callback
					will exchange the code and show a success message.
				</p>
